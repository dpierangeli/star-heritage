...
<?php /*HELP: */ 
  	    ...
  	    $query="SELECT nome_razza, sing_m, sing_f, descrizione, url_site, bonus_car0, bonus_car1, bonus_car2, bonus_car3, bonus_car4, bonus_car5, immagine, icon, Taglia  FROM razza WHERE visibile = 1 ORDER BY nome_razza";
