	...
	/* Eseguo la query e le formattazioni */
      ...
      //
          ...
          //
					...
					$add_chat.=' ';          
					$add_chat.= gdrcd_hidechat(gdrcd_chatcolor(gdrcd_filter('out',$row['testo'])));
				break;
        ...
        // MASTER
				case 'M':
					$add_chat.= ' [color=red]'.gdrcd_filter('out',$row['testo']).'[/color] ';
				break;
        ...
        // ABILITA'
				case 'C':
          $az = gdrcd_hidechat(gdrcd_filter('out',$row['testo']));
          //
          if ($az != "")
          {
					  $add_chat.= ' '.gdrcd_format_time($row['ora']).' ';
        ...
        // DADO
				case 'D':
					$add_chat.= ' '.gdrcd_format_time($row['ora']).' ';
					$add_chat.= ' [color=green]'.gdrcd_filter('out',$row['testo']).'[/color] ';
				break;
