...
while ($record = gdrcd_query($result, 'fetch'))
{
	...
	if (empty($luogo_corrente)===TRUE){
       ...
       {
          if(($PARAMETERS['mode']['mapwise_links']=='OFF') && $record['privata']==0)
