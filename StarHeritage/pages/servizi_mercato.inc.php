	...
	if ($numresults>0){ ?>
       ...
       <table>
	      ...
	      <tr>
			...
			<td  class="casella_elemento">
          <div style="text-align: left;" >Disponibilità: <?php echo $row['disponib']; ?></div>
          <br />
          <div style="text-align: left;" >Stato: <?php echo $row['stato']; ?></div>
          <br />
          ...
          ?></div>
			...
			<td  class="casella_controlli"><!-- Iconcine dei controlli -->
		        <!-- Modifica -->
				<div class="controlli_elenco" style="width:100px;">
