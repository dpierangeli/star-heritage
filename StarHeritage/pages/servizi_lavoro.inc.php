...
<?php /*Scelta lavoro*/
  ...
  // Imposta come oggi data di ultimo stipendio ricevuto
  gdrcd_query("UPDATE personaggio SET ultimo_stipendio=DATE_SUB(NOW(),INTERVAL 1 DAY) WHERE nome = '".$_SESSION['login']."'"); 
