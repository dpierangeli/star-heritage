...
//Se non esiste il pg
    if (gdrcd_query($result, 'num_rows') == 0) {
      ...
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['list']['pts'] . ": " . $record['numero']); ?>
                  ...
                  <!-- Bonus -->
                  <td class="casella_elemento">
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['attacco'] == 0 ? 'none' : ''; ?>;'>
      ...
      <?php echo $record['man']; ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['difesa'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['list']['stats']['defence'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car0'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car0'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car1'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car1'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car2'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car2'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car3'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car3'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car4'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car4'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='display:<?php echo $record['bonus_car5'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
