<div class="pagina_gestione_mercato">
  ...
  <?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_charges']); ?>
        ...
        <div class='form_field'>
          <select name="disp">
            <option value="Libera" <?php if ($loaded_item['disponib'] == "Libera") {
    echo 'selected';
  } ?>>Libera</option>
            <option value="Licenza" <?php if ($loaded_item['disponib'] == "Licenza") {
    echo 'selected';
  } ?>>Licenza</option>
            <option value="Speciale" <?php if ($loaded_item['disponib'] == "Speciale") {
    echo 'selected';
  } ?>>Speciale</option>
            <option value="Riservata" <?php if ($loaded_item['disponib'] == "Riservata") {
    echo 'selected';
  } ?>>Riservata</option>
          </select>
        </div>
        ...
        <div class='form_field'>
          <select name="stato">
            <option value="nuovo" <?php if ($loaded_item['stato'] == "Nuovo") {
    echo 'selected';
  } ?>>Nuovo</option>
            <option value="usato" <?php if ($loaded_item['stato'] == "Usato") {
    echo 'selected';
  } ?>>Usato</option>
            <option value="ND" <?php if ($loaded_item['disponib'] == "ND") {
    echo 'selected';
  } ?>>ND</option>
          </select>
        </div>
  ...
  <?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_bonus']) . ' ' . gdrcd_capital_letter(gdrcd_filter('out', $PARAMETERS['names']['stats']['car5'])); ?>
        ...
        <div class='form_field'>
          <select name="nascosto">
            <option value="<?php echo 0; ?>" <?php if ($loaded_item['nascosto'] == 0) {
    echo 'selected';
  } ?>>
              NO
            </option>
            <option value="<?php echo 1; ?>" <?php if ($loaded_item['nascosto'] == 1) {
    echo 'selected';
  } ?>>
              SI
            </option>
