...
if ($_SESSION['permessi']<MODERATOR){
	...
	$elenco_oggetti=gdrcd_query("SELECT id_oggetto, nome, stato FROM oggetto ORDER BY nome", 'result');
...
<div class="panels_box">
		 ...
		 <select name="load_item">
		     <?php while($option=gdrcd_query($elenco_oggetti, 'fetch')){ ?>
			     <option value="<?php echo $option['id_oggetto']; ?>">
				     <?php echo gdrcd_filter('out',$option['nome'])." (".gdrcd_filter('out',$option['stato']).")"; ?>
				 </option>
			 <?php } 
   ...
   <form class="form_gestione" action="main.php?page=gestione_mercato" method="post">
     ...
     <div class='form_label'>
	   ...
	   <div class='form_field'>
	      <input type="text" name="scafo_oggetto" value="<?php echo (int)$loaded_item['scafo']; ?>" />
	   </div>
     ...
     <div class='form_label'>
	   ...
	   <div class='form_field'>
	      <input type="text" name="scudi_oggetto" value="<?php echo (int)$loaded_item['scudi']; ?>" />
	   </div>
     ...
     <div class='form_label'>
	   ...
	   <div class='form_field'>
	      <input type="text" name="man_oggetto" value="<?php echo (int)$loaded_item['man']; ?>" />
	   </div>
     ...
     <div class='form_label'>
	   ...
	   <div class='form_field'>
	      <input type="text" name="vel_oggetto" value="<?php echo (int)$loaded_item['vel']; ?>" />
	   </div>
     ...
     <div class='form_field'>
	      <select name="disp">
			    <option value="Libera" <?php if($loaded_item['disponib']=="Libera"){echo 'selected';}?>>Libera</option>
          <option value="Licenza" <?php if($loaded_item['disponib']=="Licenza"){echo 'selected';}?>>Licenza</option>
          <option value="Speciale" <?php if($loaded_item['disponib']=="Speciale"){echo 'selected';}?>>Speciale</option>
        </select>
	   </div>
     ...
     <div class='form_field'>
	      <select name="stato">
			    <option value="nuovo" <?php if($loaded_item['stato']=="Nuovo"){echo 'selected';}?>>Nuovo</option>
          <option value="usato" <?php if($loaded_item['stato']=="Usato"){echo 'selected';}?>>Usato</option>
          <option value="ND" <?php if($loaded_item['disponib']=="ND"){echo 'selected';}?>>ND</option>
        </select>
	   </div>
     ...
     <div class='form_label'>
	   ...
	   <div class='form_field'>
	      <select name="nascosto">
		      <option value="<?php echo 0; ?>" <?php if($loaded_item['nascosto']==0){echo 'selected';}?>>
		         NO
			  </option>
        <option value="<?php echo 1; ?>" <?php if($loaded_item['nascosto']==1){echo 'selected';}?>>
		         SI
			  </option>
        </select>
	   </div>
