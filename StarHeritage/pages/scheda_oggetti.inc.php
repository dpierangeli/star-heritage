...
//Se non esiste il pg
    if (gdrcd_query($result, 'num_rows') == 0) {
      ...
      <div class="page_body">
        <div class="panels_box">
          <?php
          /* Oggetti nello zaino */
          $query = "SELECT oggetto.id_oggetto, oggetto.nome AS nome_oggetto, oggetto.descrizione, oggetto.urlimg, oggetto.ubicabile, oggetto.difesa, oggetto.attacco, oggetto.bonus_car0, oggetto.bonus_car1, oggetto.bonus_car2, oggetto.bonus_car3, oggetto.bonus_car4, oggetto.bonus_car5, oggetto.scafo, oggetto.scudi, oggetto.man, oggetto.vel, oggetto.nascosto, clgpersonaggiooggetto.* FROM clgpersonaggiooggetto LEFT JOIN oggetto ON clgpersonaggiooggetto.id_oggetto=oggetto.id_oggetto WHERE clgpersonaggiooggetto.nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "' AND clgpersonaggiooggetto.posizione = 0 ORDER BY oggetto.nome DESC";
          $result = gdrcd_query($query, 'result');
          ?>
    ...
    <?php echo "&nbsp;"; ?>
              ...
              while ($record = gdrcd_query($result, 'fetch')) {
                if ($record['nascosto'] == 1 && ($_SESSION['login'] != gdrcd_filter('get', $_REQUEST['pg']) && $_SESSION['permessi'] < GAMEMASTER))
                  continue;
                ?>

                <tr>
                  <!-- Oggetto, immagine, quantità -->
                  <td class="casella_elemento" style='width:90px; '>
                    <div class="inventario_nome"><?php echo gdrcd_filter('out', $record['nome_oggetto']); ?></div>
                    <div class="inventario_img">
                      <img style="max-width:200px; max-height:200px;" src="themes/<?php echo $PARAMETERS['themes']['current_theme'] ?>/imgs/items/<?php echo gdrcd_filter('out', $record['urlimg']); ?>" />
                    </div>
      ...
      ?>
                  ...
                  <!-- Bonus -->
                  <td class="casella_elemento" style='width:90px; '>
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['attacco'] == 0 ? 'none' : ''; ?>;'>
      ...
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['list']['stats']['attack'] . ": "); ?>
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['scafo'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                        Scafo:
                      </div>
                      <div style="float: right; clear: right;">
                        <?php echo $record['scafo']; ?>
                      </div>
                    </div>
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['scudi'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                        Scudi:
                      </div>
                      <div style="float: right; clear: right;">
                        <?php echo $record['scudi']; ?>
                      </div>
                    </div>
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['man'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                        Manovrabilità:
                      </div>
                      <div style="float: right; clear: right;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['vel'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                        Velocità:
                      </div>
                      <div style="float: right; clear: right;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['difesa'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car0'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car1'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car2'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car3'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car4'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
                    ...
                    <div class="inventario_riga_proprieta" style='width:80px; display:<?php echo $record['bonus_car5'] == 0 ? 'none' : ''; ?>;'>
                      <div style="float: left; clear: left;">
      ...
      <?php
      // echo str_replace("\n", "<br/>", gdrcd_filter('out',$record['descrizione']));
      echo str_replace("\n", "<br/>", $record['descrizione']);
      ?>
                      ...
                      <div>
                        ...
                        <form action="main.php?page=scheda_oggetti"
                          ...
                          <input type="hidden"
                                 ...
                                 name="id_oggetto" />
                          <textarea type="textbox" name="commento" class="form_textarea" style='margin-top: 10px;' ><?php echo $record['commento']; ?></textarea>
                          <input type="submit"
