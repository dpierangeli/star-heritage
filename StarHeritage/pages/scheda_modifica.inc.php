    ...
    if ($confirm_updating) {
      ...
      if (isset($_POST['op']) === TRUE) {
        ...
        if ((gdrcd_filter('get', $_REQUEST['pg']) == $_SESSION['login']) && (gdrcd_filter('get', $_POST['op']) == 'modify')) {
          ...
          $modifica_eta = gdrcd_filter('num', $_POST['modifica_eta']);
          $modifica_contatti = gdrcd_filter('in', $_POST['modifica_contatti']);
          ...
          if ($PARAMETERS['mode']['user_bbcode'] == 'OFF' || ($PARAMETERS['mode']['user_bbcode'] == 'ON' && $PARAMETERS['settings']['forum_bbcode']['type'] == 'bbd' && $PARAMETERS['settings']['bbd']['free_html'] == 'ON')) {
            ...
            $modifica_contatti = gdrcd_filter('addslashes', $_POST['modifica_contatti']);
          }
          ...
          gdrcd_query("UPDATE personaggio SET cognome = '" . gdrcd_filter('in', $_POST['modifica_cognome']) . "', affetti = '" . $modifica_affetti . "', descrizione = '" . $modifica_background . "', url_media = '" . gdrcd_filter('in', $_POST['modifica_url_media']) . "', blocca_media = " . (int) $blocca_media . ", url_img = '" . gdrcd_filter('in', $_POST['modifica_url_img']) . "', url_img_chat = '" . gdrcd_filter('in', $_POST['modifica_url_img_chat']) . "', online_status = '" . $online_state . "', Eta=" . $modifica_eta . ", contatti='" . $modifica_contatti . "' WHERE nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "'");
        ...
        elseif (($_SESSION['permessi'] >= GUILDMODERATOR) && (gdrcd_filter('get', $_POST['op']) == 'modify_status')) {
          gdrcd_query("UPDATE personaggio SET stato = '" . gdrcd_filter('in', $_POST['modifica_status']) . "', salute = " . gdrcd_filter('num', $_POST['modifica_salute']) . ", forza = " . gdrcd_filter('num', $_POST['modifica_forza']) . ", note_segrete='" . gdrcd_filter('in', $_POST['modifica_segrete']) . "' WHERE nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "'");
        ...
        $record = gdrcd_query("SELECT descrizione, affetti, cognome, online_status, url_img, url_img_chat, url_media, blocca_media, stato, salute, Eta, forza, forza_max, contatti, note_segrete FROM personaggio WHERE nome='" . gdrcd_filter('get', $_REQUEST['pg']) . "'");
      }
    }
    ?>
    ...
    <?php if (isset($_POST['op']) === FALSE) { ?>
      ...
      if ($PARAMETERS['mode']['user_online_state'] == 'ON') {
        ?>
                ...
                <div class='form_field'>
                  <input type="text" name="modifica_eta" class="form_input" value="<?php echo $record['Eta']; ?>" />
                </div>
      ...
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['help']['bbcode']); ?>
                ...
                <div class='form_field'>
                  <textarea type="textbox" name="modifica_contatti" class="form_textarea"><?php echo $record['contatti']; ?></textarea>
                </div>
                <div class="form_info">
                  <?php echo gdrcd_filter('out', $MESSAGE['interface']['help']['bbcode']); ?>
                </div>
      ...
      ?>
                ...
                <div class='form_submit'>
                  <input type="submit" value="Conferma le modifiche" class="form_submit" />
                  <input type="hidden"
      ...
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['modify_form']['status']); ?>
                ...
                <div class='form_field'>
                  <textarea type="textbox" name="modifica_segrete" class="form_textarea"><?php echo $record['note_segrete']; ?></textarea>
                </div>
      ...
      <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['modify_form']['healt']); ?>
                ...
                <div class='form_label'>
                  Modifica Punti Forza
                </div>
                <div class='form_field'>
                  <input class="healt_input" name="modifica_forza" value="<?php echo $record['forza']; ?>" />/<?php echo $record['forza_max']; ?>
                </div>

                <div class='form_submit'>
                  <input type="submit" value="Conferma le modifiche (Area Master)" />
                  <input type="hidden"
                         value="<?php echo gdrcd_filter('get', $_REQUEST['pg']); ?>"
                         name="pg" />
                </div>
      ...
      <?php }//for  ?>
                ...
                <div class='form_submit'>
                  <input type="submit" value="Conferma Esilio" />
                  <input type="hidden"
                         value="<?php echo gdrcd_filter('get', $_REQUEST['pg']); ?>"
                         name="pg" />
                </div>
