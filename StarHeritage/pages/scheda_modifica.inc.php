	...
	*/
	if ($confirm_updating)
	{
		...
		} else
		{
			...
			$record = gdrcd_query("SELECT descrizione, affetti, cognome, online_status, url_img, url_img_chat, url_media, blocca_media, stato, salute, Eta, forza, forza_max, contatti FROM personaggio WHERE nome='".gdrcd_filter('get',$_REQUEST['pg'])."'");
		}
