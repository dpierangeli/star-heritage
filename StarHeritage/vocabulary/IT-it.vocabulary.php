...
$MESSAGE['register']['fields']['gender_m']='Maschio';
$MESSAGE['register']['fields']['gender_f']='Femmina';
...
$MESSAGE['register']['fields']['years']='Età del personaggio';
$MESSAGE['register']['fields']['years_info']='L\'Età ha un valore minimo e massimo dettati dalla Razza; a seconda dell\'età scelta verranno applicati bonus o malus alle caratteristiche fisiche ed ai punti esperienza iniziali (personaggi più vecchi avranno malus alle caratteristiche ma bonus ai punti esperienza)';
$MESSAGE['register']['summary']='Riepilogo';
/* Condizioni */
$MESSAGE['register']['disclaimer']='Registrazione (ai sensi del D. Lgs n°196/2003 - Codice in materia di protezione dei dati personali): L\'utente, registrandosi, presta il consenso al trattamento dei suoi dati ed autorizza l\'inserimento degli stessi nella banca dati del gioco con il fine di inserirli nell\'elenco dei suoi utenti. Gli stessi dati NON saranno ceduti e/o utilizzati da alcun soggetto estraneo a chi, attualmente o in futuro, gestisce il presente gioco. I dati saranno trattati con strumenti elettronici e informatici al solo scopo di partecipare al gioco e di ricevere eventuali e indispensabili comunicazioni tecniche via e-mail (come l’invio della password all’indirizzo di posta elettronica dichiarata in sede di registrazione). Autorizzando il trattamento dei dati, l’utente autorizza non solo la registrazione dell’indirizzo e–mail, ma permette anche la registrazione dell’indirizzo IP, l’ora dell’iscrizione e l’ora di ogni login. L\'indicazione di dati personali completi è assolutamente volontaria e facoltativa. L\'interessato potrà  in ogni momento e gratuitamente esercitare i diritti di cui all\'art. 7 del D.Lgs n°196/2003, quali: la possibilità  di accedere ai registri del Garante, ottenere informazioni in relazione ai dati che lo riguardano, ottenere la cancellazione o il blocco, ovvero l\'aggiornamento, la rettifica o l\'integrazione dei dati, inviando una e-mail all\'indirizzo indicato nella home page.';
$MESSAGE['register']['rules_read']='L\'utente dichiara inoltre di aver preso visione del regolamento, come proposto in homepage e qui riportato, di averlo compreso ed accettato in ogni sua parte, e di rispondere a tutti i requisiti richiesti, comprese le eventuali restrizioni di età.';
/* Benvenuti */
...
$MESSAGE['register']['welcome']['message'][4]="Lo staff e' lieto di darti il benvenuto e ti augura buon divertimento! Hai gia' letto l\ambientazione ed il regolameto? Se non e' così ti invitiamo a farlo al più presto!.";
/* Errori */
...
$MESSAGE['register']['error']['years_min']='L\'età specificata è troppo bassa per la razza scelta; l\'età minima è ';
$MESSAGE['register']['error']['years_max']='L\'età specificata è troppo alta per la razza scelta; l\'età massima è ';
...
$MESSAGE['interface']['sheet']['modify_form']['url_img_chat']='URL immagine di chat (50x50)';
...
$MESSAGE['interface']['sheet']['modify_form']['admin']['url_img']='URL Avatar';
...
$MESSAGE['interface']['sheet']['info_skill_cost']='Il costo di incremento di un\'abilità segue questa tabella: 01-48 = 1px; 49-56 = 2px; 57-62 = 3px; 63-67 = 4px; 68-100 = 5px';
...
/* Tipi forum*/
$MESSAGE['interface']['forums']['type'][0]='ON';
$MESSAGE['interface']['forums']['type'][1]='OFF';
$MESSAGE['interface']['forums']['type'][2]=strtolower($PARAMETERS['names']['race']['sing']).'';
$MESSAGE['interface']['forums']['type'][3]='Corporazione';
$MESSAGE['interface']['forums']['type'][4]='Master';
$MESSAGE['interface']['forums']['type'][5]='Admin';
/*Servizi bancari*/
...
$MESSAGE['interface']['job']['ok_quit']='Dimissione avvenuta.';
